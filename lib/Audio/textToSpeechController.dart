...
//     language = await tts.getDisplayLanguageByCode(langCode);
//     languageCode = langCode;
//     voice = await getVoiceByLang(langCode);
//   }
//
//   void speak(String textToPlay) {
